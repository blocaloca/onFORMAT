                                    ...
                                    <div key={item.id} className="grid grid-cols-[1fr_100px_100px_100px_150px_30px] gap-4 py-2 items-center hover:bg-zinc-50 transition-colors px-2">
                                        ...
                                        <div>
                                            <input
                                                ...
                                                className={`w-full bg-transparent text-xs font-bold uppercase focus:outline-none focus:bg-white focus:ring-1 focus:ring-zinc-400/10 rounded px-1 py-1 text-black ${isPrinting ? 'hidden' : 'print:hidden'}`}
                                                disabled={isLocked}
                                            />
                                        ...
                                        <div>
                                            <input
                                                ...
                                                className={`w-full bg-transparent text-xs font-mono font-bold text-right focus:outline-none focus:bg-white focus:ring-1 focus:ring-zinc-400/10 rounded px-1 py-1 text-black ${isPrinting ? 'hidden' : 'print:hidden'}`}
                                                placeholder="0.00"
                                                disabled={isLocked}
                                            />
