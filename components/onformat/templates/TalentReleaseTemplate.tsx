    ...
    return (
        ...
        >
            <div className={`space-y-6 text-sm font-sans h-full flex flex-col max-w-2xl mx-auto ${isPrinting ? 'text-black' : 'text-zinc-800'}`}>
                ...
                <div className="flex items-end justify-between border-b-2 border-black pb-2 mb-4 shrink-0">
                    <div className="flex-1 max-w-[50%]">
                        ...
                        <input
                            ...
                            className="w-full bg-transparent border-b border-transparent hover:border-zinc-200 text-sm font-bold px-2 py-1 outline-none text-zinc-900 placeholder:text-zinc-400 uppercase tracking-wide rounded-sm transition-all"
                    ...
                    <div className="flex-1 text-right">
                        ...
                        <input
                            ...
                            className="bg-transparent border-b border-transparent hover:border-zinc-200 text-sm font-mono font-bold px-2 py-1 outline-none text-right text-zinc-900 rounded-sm transition-all"
                ...
                <div className="flex-1 relative min-h-0 mb-4 border border-zinc-100 rounded bg-transparent p-4">
                    <div className="h-full overflow-y-auto pr-2 custom-scrollbar">
                        {isLocked || isPrinting ? (
                            ...
                            <textarea
                                className="w-full h-full bg-transparent rounded-sm border border-transparent hover:border-zinc-200 p-2 text-sm leading-relaxed resize-none outline-none text-zinc-900 placeholder:text-zinc-400 font-serif text-justify transition-all"
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                        <div className="col-span-1">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent border-b border-transparent hover:border-zinc-200 rounded-sm p-2 text-sm font-bold focus:border-zinc-400 outline-none transition-all text-zinc-900 placeholder:text-zinc-400"
                        ...
                        <div className="col-span-1">
                            ...
                            <input
                                ...
                                className="w-full bg-transparent border-b border-transparent hover:border-zinc-200 rounded-sm p-2 text-sm focus:border-zinc-400 outline-none transition-all text-zinc-900 placeholder:text-zinc-400"
                                placeholder="Role"
                                disabled={isLocked || !!data.signatureUrl}
                            />
                        </div>
                        ...
                        <div className={`flex flex-col items-center gap-2 ${isPrinting ? 'hidden' : 'block'}`}>
                            <div className="border border-zinc-300 rounded bg-white shadow-sm overflow-hidden w-full max-w-[400px] p-4 flex flex-col items-center">
                                ...
                                <input
                                    ...
                                    className="w-full text-center font-bold text-lg bg-transparent border-b border-transparent hover:border-zinc-200 text-zinc-900 placeholder:text-zinc-400 outline-none focus:border-emerald-500 rounded-sm transition-all py-2 mb-2 font-mono"
                            ...
                            <div className="flex gap-2 mt-2">
                                <button
                                    ...
                                    className="flex items-center gap-1 text-[10px] font-bold uppercase text-zinc-400 hover:text-black dark:hover:text-zinc-100 px-3 py-1 bg-transparent border border-zinc-200 rounded"
                                >
                                    Clear
                                </button>
                                <button
