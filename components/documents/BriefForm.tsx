...
const BriefForm = forwardRef<BriefFormHandle, BriefFormProps>(({ content, onChange }, ref) => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 rounded-xl border border-[#E5E5EA] dark:border-zinc-800 shadow-sm overflow-hidden">
      <div className="p-4 border-b border-[#E5E5EA] dark:border-zinc-800 bg-gray-50 dark:bg-zinc-800/50">
        <h2 className="font-semibold text-[#1D1D1F] dark:text-zinc-100">Creative Brief</h2>
      ...
      <div className="p-6 space-y-6">
        {/* Project Objective */}
        <div>
          <label className="block text-sm font-medium text-[#1D1D1F] dark:text-zinc-300 mb-2">
            Project Objective
          </label>
          <textarea
            ...
            className="w-full px-4 py-3 bg-white dark:bg-zinc-950 border border-[#E5E5EA] dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none text-[#1D1D1F] dark:text-zinc-100 placeholder:text-gray-400 dark:placeholder:text-zinc-600"
            rows={4}
          />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white dark:bg-zinc-950 border border-[#E5E5EA] dark:border-zinc-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-[#1D1D1F] dark:text-zinc-100 placeholder:text-gray-400 dark:placeholder:text-zinc-600"
            />
          </div>
