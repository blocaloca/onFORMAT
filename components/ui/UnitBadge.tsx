...
export const UnitBadge = ({ unit, className, size = 'md' }: UnitBadgeProps) => {
    const colors = {
        'A': 'bg-rose-600 text-white shadow-rose-900/20',
        'B': 'bg-blue-600 text-white shadow-blue-900/20', // Boosted blue for contrast
        'C': 'bg-amber-500 text-white shadow-amber-900/20',
    };
